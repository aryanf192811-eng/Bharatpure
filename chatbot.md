...
- **Result/Notes (round 1):** Done. Created `ai/data/turmeric_historical.csv` (11,795 rows, 2018-2023, Maharashtra/Telangana) and `ai/data/mustard_historical.csv` (11,842 rows, 2018-2023, Rajasthan/Haryana) plus `docs/research/demand-training-data-cleaning.md`.
